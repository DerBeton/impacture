  ...
  <div class="home-view">
    <div class="container">
      ...
      <div class="house-container">
        <ToolTip @action="isIntroStarted = true" class="tip" title="Dein Haus" text="Hey, Glückwunsch! Du bist erwachsen, zahlst Miete und wohnst jetzt in diesem Haus! Doch hast du dich jemals gefragt, wie deine Entscheidungen zukünftige Generationen beeinflussen können?" action-text="Eigentlich nicht"></ToolTip>
